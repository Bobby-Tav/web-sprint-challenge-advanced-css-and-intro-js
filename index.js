...
function get20s(array){
  let newArray = [];
  let regEx = /19[0-9][0-9] - [1-2][0-9][0-9][0-9]/;
  for(let i = 0; i < array.length;i++){
    if(array[i].years.match(regEx))
...
function addArtist(array){
  array.push({id: 20,
    ...
    bio:'Lorem ipsum dolor sit amet consectetur adipisicing elit. Laboriosam neque voluptate, iure ipsum amet beatae ab reprehenderit odit dicta dolorum velit odio rem delectus quod perferendis sunt tenetur, distinctio esse!'});
    return array;
  }
